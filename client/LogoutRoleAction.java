...
/********************************************************************
* @(#)LogoutRoleAction.java.java 1.01 20110304
* Copyright (c) 2011 by Richard T. Salamone, Jr. All rights reserved.
*
* LogoutRoleAction.java: Action to log a group of users off the
* system based on office/role.
*
...
public final class LogoutRoleAction
	extends SBAction
	{
	public LogoutRoleAction( ClientApp aClientApp )
		{
		super( "Logout", 'L', "Logout a group of users", null );
	...
	@Override public void actionPerformed(ActionEvent evt)
		...
		while ( true )
			...
			try
				...
				fClientApp.broadcast( ClientOp.LOGOUT, audience, "");
